...
const storage = isNode ? nodeLocalStorage : window.localStorage;
...
const getAppParams = () => {
	...
	const env = /** @type {{ VITE_BASE44_APP_ID: string; VITE_BASE44_FUNCTIONS_VERSION: string; VITE_BASE44_APP_BASE_URL: string; }} */ ((/** @type {any} */ (import.meta)).env);
	return {
